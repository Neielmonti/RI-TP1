...
class Indexer:
    ...
    def cargar_indice(self, epoch):
        return self.textProcessor.cargar_indice(0)


def main():
    parser = argparse.ArgumentParser(description="Indexador de documentos")
    parser.add_argument("--path", type=str, required=True, help="Ruta al directorio con archivos HTML")
